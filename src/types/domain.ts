...
export interface BudgetItem {
    ...
    hydrationStatus?: 'none' | 'pending_review' | 'internal_db' | 'analytic_file' | 'manual' | 'error';
    hydrationDetails?: Record<string, any>; // JSONB details (e.g. pending_reason, parser_version)
    updatedAt: Date;
}
