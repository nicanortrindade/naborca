-- ============================================================================
-- NABOORÇA • FIX FINALIZE IDEMPOTENCY (V2 - Based on 20260228)
-- Migration: 20260301_fix_finalize_idempotency.sql
-- Data: 2026-03-01
-- ============================================================================
-- OBJETIVO:
--   1. Adicionar bloqueio (FOR UPDATE) no início da finalize_import_to_budget para evitar race conditions.
--   2. Corrigir o bloco de idempotência para retornar imediatamente se o job já estiver em pending_hydration ou finalized.
--   3. Preservar as melhorias de inferência de nomes e stop-words da versão 20260228.
-- ============================================================================
