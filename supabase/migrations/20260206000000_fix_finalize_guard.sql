-- Migration: Strict Failure Checks for Finalization
-- Date: 2026-02-06
-- Objective: Prevent finalize_import_to_budget from creating budgets if job is in failed state or has zero real items.
