-- Migration: Implement Structure Parser V1 (Regex Level Detection)
-- Author: Antigravity Agent
-- Date: 2026-02-05
-- Objective: Parse N1/N2/N3 hierarchy from import_ai_items description when enable_structure_parser_v1 is true.
...
-- Try to extract code from description (legacy/fallback code extraction logic)
...
VALUES (
        ...
        v_items_processed,
        CASE
            WHEN v_use_parser THEN jsonb_build_object(
                'parser_version',
                'structure_v1',
                'detected_level',
                CASE
