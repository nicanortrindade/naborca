-- =============================================================================
-- Migration M15: Calculate custom_bdi from total/(qty*unit_price) ratio
-- 
-- Instead of relying on import_ai_items.bdi_percent (which is never persisted
-- by index.ts), this version calculates the BDI ratio in-place and matches
-- it against the bdi_rates array sent by the frontend in p_params.
--
-- Based on stable M13. Only changes:
--   1. Added v_bdi_ratio, v_bdi_rate_elem, v_bdi_rate_val, v_bdi_expected (DECLARE)
--   2. Replaced v_item.bdi_percent read with ratio calculation (line ~409)
-- =============================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- =====================================================================
        -- M15: Calculate BDI from total / (qty * unit_price) ratio
