-- Migration: fix_finalize_compositions_user_id
-- Created at: 2026-02-20
-- Description: Adiciona user_id e metadata nos INSERTs de budget_item_compositions
--              nas Hydrations A e B. Remove coluna type. Parser ativo por default.
